...
<html>
   ...
   <body>
      ...
      <div id="page">
         ...
         <div id="colorlib-services" class="myClearFixed">
            <div class="container">
               <div class="row">
                  <center>
                     <h2 style="color: #302939;">
                        <span class="underline-black black-text">O</span><span class="underline-green black-text">ur</span> services
                     </h2>
                  </center>
                  <div class="col-md-3 col-sm-4 col-xs-6 animate-box text-center fadeInUp animated-fast">
      ...
      <div class="container">
         <div class="row">
            <div class="col-lg-12 col-sm-12 col-xs-12">
               ...
               <hr>
               <div class="col-lg-3 col-md-3 col-xs-12 float-left mt-3">
                  <a href="Appointment.php">
                  <img style="width: 250px; height: auto;"  class="img-fluid service-feature" src="my_image/side_image/side_image01.png"
                     alt="HomeMaid">
                  </a>
               </div>
               <div class="col-lg-9 col-md-9 col-xs-12 float-right" style=" text-align: center;     padding: 4em 0 0 0;">
                  <div class="row h6mt">
      ...
      <hr/>
      <div id="colorlib-subscribe" style="padding: 4em 0; background-color:#74c043; text-align:center;" >
         <!-- <div></div> -->
         <div class="container" >
            <div class="row" >
               <div class="col-md-3">
                  <span class="counter">
                     <h2 class="counter-statistic"  style="color: #ffffff">200</h2>
               ...
               <div class="col-md-3">
                  <span class="counter">
                  <h2 class="counter-statistic"  style="color: #ffffff">3000</h2>
                  <!-- <i class="fa fa-plus" aria-hidden="true"></i> </span> -->
                  <h6  style="color: #ffffff">Hours Served</h6>
               </div>
               <div class="col-md-3">
                  <span class="counter"> 
                  <h2 class="counter-statistic"  style="color: #ffffff">50</h2>
                  <!-- <i class="fa fa-plus" aria-hidden="true"></i> </span> -->
                  <h6  style="color: #ffffff">Hours Appoint / Daily</h6>
               </div>
               <div class="col-md-3">
                  <span class="counter">
                     <h2 class="counter-statistic"  style="color: #ffffff">100</h2>
                     <!-- <i class="fa fa-plus" aria-hidden="true"></i> -->
                  </span>
